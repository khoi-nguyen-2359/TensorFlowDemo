...
#ifndef COM_MEDIA2359_CPP_OBJECT_TRACKING_IMAGE_UTILS_H_
#define COM_MEDIA2359_CPP_OBJECT_TRACKING_IMAGE_UTILS_H_
...
#endif  // COM_MEDIA2359_CPP_OBJECT_TRACKING_IMAGE_UTILS_H_
