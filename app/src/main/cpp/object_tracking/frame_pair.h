...
#ifndef COM_MEDIA2359_CPP_OBJECT_TRACKING_FRAME_PAIR_H_
#define COM_MEDIA2359_CPP_OBJECT_TRACKING_FRAME_PAIR_H_
...
#endif  // COM_MEDIA2359_CPP_OBJECT_TRACKING_FRAME_PAIR_H_
