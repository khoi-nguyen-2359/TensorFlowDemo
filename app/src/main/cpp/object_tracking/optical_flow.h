...
#ifndef COM_MEDIA2359_CPP_OBJECT_TRACKING_OPTICAL_FLOW_H_
#define COM_MEDIA2359_CPP_OBJECT_TRACKING_OPTICAL_FLOW_H_
...
#endif  // COM_MEDIA2359_CPP_OBJECT_TRACKING_OPTICAL_FLOW_H_
